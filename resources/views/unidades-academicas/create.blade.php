...
@section('content')
    <div class="card">
        ...
        <form action="{{ route('unidades-academicas.store') }}" method="POST">
            @csrf
            <div class="card-body">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   ...
                                   name="nombre" 
                                   value="{{ old('nombre') }}"
                                   placeholder="Ej: Facultad de Humanidades"
                                   required>
                            @error('nombre')
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('descripcion') is-invalid @enderror" 
                              ...
                              name="descripcion" 
                              rows="3"
                              placeholder="Descripción breve de la unidad académica">{{ old('descripcion') }}</textarea>
                    @error('descripcion')
                        <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
                </div>
